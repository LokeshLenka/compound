...
import { journalSchema, splitTags, type JournalFormValues } from "@/lib/schemas"
import type { JournalEntry } from "@/lib/types"
import { useSaveJournalEntry, useDeleteJournalEntry } from "@/features/journaling/use-journaling"
...
export function JournalFormDialog({
  ...
  const { register, reset, handleSubmit, setValue, watch, formState } =
    useForm<JournalFormValues>({
      ...
      defaultValues: { title: "", content: "", mood: null, tags: [], category: "" },
    })
        ...
        >
          ...
          <aside className="shrink-0 border-t p-4 sm:p-5 lg:w-72 lg:border-t-0 lg:border-l lg:overflow-y-auto">
            <div className="space-y-5">
              ...
              {/* Category */}
              <div className="space-y-2.5">
                <Label htmlFor="journal-category" className="text-xs font-medium uppercase tracking-wider text-muted-foreground">
                  Category
                </Label>
                <Input
                  id="journal-category"
              ...
              {/* Tags */}
              <div className="space-y-2.5">
                <Label htmlFor="journal-tags" className="text-xs font-medium uppercase tracking-wider text-muted-foreground">
                  Tags
                </Label>
                <Input
                  id="journal-tags"
